...
internal object CareerRepositorySample: CareerRepository {
  override suspend fun getMyCareers(option: CareerListOption): List<CareerListItem> {
    delay(500)
    return listOf(
      CareerListItem(
        id = 1,
        companyName = "라임프렌즈",
        companyImageUrl = "https://yt3.googleusercontent.com/-244NNBAxeCA4EYtDNUQdDh1ThoK7N45DgBnZGBl7gyLry_aYeQsw4iKcxpHXlZwMBRm3xkU=s900-c-k-c0x00ffffff-no-rj",
        position = "안드로이드 개발자",
        ...
        skills = listOf(
          ...
          "MVVM",
          "Hilt",
        ).mapIndexed(::CareerSkill)
      )
    )
  }

  override suspend fun getCareer(id: Int): CareerDetail {
    delay(500)
    return CareerDetail(
      id = 1,
      companyName = "라임프렌즈",
